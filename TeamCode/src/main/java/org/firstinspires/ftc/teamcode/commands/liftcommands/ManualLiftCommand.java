...
import static org.firstinspires.ftc.teamcode.util.CrossBindings.square;
...
public class ManualLiftCommand extends CommandBase {
    ...
    private final double up = -0.4; // 0.75
    private final double down = 0.75; // -0.4

    private final double slowUp = -1.0; // 0.37
