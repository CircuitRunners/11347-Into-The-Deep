...
//                .whenActive(new LiftToScoringCommand(diffy, lift, LiftToScoringCommand.Presets.HIGH, arm)
//                        .withTimeout(3500)
...
//        //LIFT
//        new Trigger(() -> manipulator.getLeftY() < -0.4)
//                .whenActive(new LiftToScoringCommand(diffy, lift, LiftToScoringCommand.Presets.DOWN, arm)
//                        .withTimeout(2500)
//                        .interruptOn(() -> manualLiftCommand.isManualActive()));
//
//        //ARM
...
//                .whenActive(new LiftToScoringCommand(diffy, lift, LiftToScoringCommand.Presets.SHORT, arm)
//                        .withTimeout(2500)
//                        .interruptOn(() -> manualLiftCommand.isManualActive()));
//
//        //Short preset
